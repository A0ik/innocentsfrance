...
const stats = [
    { value: 18, suffix: " ans", label: "d'existence", icon: Award },
                ...
                <div className="flex flex-col md:flex-row gap-12 items-center mb-24">
                    <div className="flex-1">
                        ...
                        <div className="space-y-4 text-lg text-gray-700 leading-relaxed">
                            <p>
                                Fondée en 2008, Innocents France est née d'un constat simple : l'aide humanitaire doit être rapide, directe et humaine.
                            </p>
                            <p>
