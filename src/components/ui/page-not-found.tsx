        ...
        <div className="absolute flex flex-col justify-center items-center w-[90%] h-[90%] z-[100]">
            ...
            >
                ...
                <div className="flex gap-6 mt-8">
                    <button
                        onClick={() => router.back()}
                        className="text-black border-2 border-black hover:bg-black hover:text-white transition-all duration-300 ease-in-out px-6 py-2 h-auto text-base font-medium flex items-center gap-2 hover:scale-105 cursor-pointer"
                    >
                        <svg
                    ...
                    <button
                        onClick={() => router.push("/")}
                        className="bg-black text-white hover:bg-gray-900 transition-all duration-300 ease-in-out px-6 py-2 h-auto text-base font-medium flex items-center gap-2 hover:scale-105 cursor-pointer"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="20"
