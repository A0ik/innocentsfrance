    ...
    return (
        <footer className="bg-primary text-white py-12 pb-24 border-t border-white/10">
            <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    <h4 className="font-bold mb-4">Faire un don PayPal</h4>
                    <div className="bg-white/10 rounded-xl p-4 backdrop-blur-sm">
                        <div className="relative w-full aspect-square max-w-[120px] mx-auto">
                            <Image
                                src="/images/paypalqrcode.png"
                                alt="QR Code PayPal pour faire un don"
                                fill
                                className="object-contain rounded-lg"
                            />
                        </div>
                        <p className="text-xs text-center mt-3 opacity-70">Scannez pour donner</p>
                    </div>
                </div>
            </div>
        </footer>
